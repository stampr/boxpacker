...
// describe('VolumePackerTest', function() {
//   it('testPackBoxThreeItemsFitEasily');
//   it('testPackBoxThreeItemsFitExactly');
//   it('testPackBoxThreeItemsFitExactlyNoRotation');
//   it('testPackBoxThreeItemsFitSizeButOverweight');
//   it('testPackBoxThreeItemsFitWeightBut2Oversize');
//   it('testPackTwoItemsFitExactlySideBySide');
//   it('testPackThreeItemsBottom2FitSideBySideOneExactlyOnTop');
//   it('testPackThreeItemsBottom2FitSideBySideWithSpareSpaceOneOverhangSlightlyOnTop');
//   it('testPackSingleItemFitsBetterRotated');
//   it('testIssue20');
//   it('testIssue53');
//   it('testConstraints');
// });
